...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "Designed a podcast streaming application with search and playback features powered by React and Firebase.",
  ...
  },
  {
    ...
    image: project2,
    description:
      " Implemented an e-commerce solution with cart management, product listing, and secure database connectivity using React and Firebase.",
  ...
  },
  {
    ...
    image: project4,
    description:
      "Created a dynamic food ordering platform featuring a responsive UI, real-time order tracking, and Firebase integration.",
    technologies: ["HTML", "CSS", "React", "mySQL"],
  },
];

export const CONTACT = {
  address: "Taximens Colony,kurla (W), Maharastra, Mumbai-400070 ",
  phoneNo: "7977370509",
  email: "Shahidchaudhary52@gmail.com",
};
